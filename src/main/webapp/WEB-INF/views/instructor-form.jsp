...
<head>
	...
	<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/add-instructor-style.css ">
...
<body>
	...
	<div id="container">
		...
		<form:form action="saveInstructor" modelAttribute="instructor" method="POST">
			<!--  neet to associate this data with instructor id -->
			<form:hidden path="id"/>
